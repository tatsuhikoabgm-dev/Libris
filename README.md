...
https://github.com/user-attachments/assets/a6928aef-22db-48f6-93a4-9dc09b65eaba
...
##  更新記録
- 2025-12-04: いったん本腰をいれてOptionalについてメソッドや概念的なものを含めて理解するために学習中。実装が止まるｗ
  ラムダ式を覚える絶好の機会だと思い、問題を解いています。特に今回はオブジェクト型にインスタンスメソッド、staticメソッドがある、というところを面白く感じています。
- 2025-12-02: 書籍検索画面の検索と表示機能の実装が終わる。実際に見える形になったのでテンションがぶちあがる！！
- 2025-11-30: MapperのInterFaceとXMLの作成がすべて終わる。テスト用のコントローラーを作成し、直接Mapperを呼んで期待通りの値をコンソールに出力することができた。
- 2025-11-29: Mapperを書いていたらエラーがでてどうやっても直らなかった。調べまくった結果Spring4.0.0とMybatisの相性が悪くて戻り値にStringを指定するとエラーがでるとのこと。
POMを3.5に変更してプロジェクトを更新し事なきを得る。
- 2025-11-28: [Entity,Enum,DTOのPGが終わった](https://github.com/user-attachments/assets/c80b89ae-6743-4795-8696-7e7de1046e68)
