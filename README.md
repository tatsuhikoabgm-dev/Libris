...
- 2025-11-26: 日本語で処理フローを書くときに難しさを感じる。ページDTOを作るメソッド内でAPIを叩きＤＢからステータスを取得しページDTOに詰め込む
この処理を日本語で書こうとするとAPIから情報を取得→ステータスをDBから取得→ページDTOに詰める、になっちゃうｗifもアクティブのフラグ立てるときにだけ書くのにelseの分も書かなきゃとかなっちゃうｗ
